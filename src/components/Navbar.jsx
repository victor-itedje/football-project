  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10' >
      <div class="container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent">
       ...
       <Link to="/dashboard"><button className="hidden cursor-pointer md:block border-2 bg-white px-8 py-5 rounded-full"><img src={assets.avatar} className='w-[20px]' /></button></Link>
